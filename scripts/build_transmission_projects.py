...
def add_new_buses(n, new_ports):
    ...
    added_buses = n.add(
        ...
        substation_lv=to_add["node_type"] == "POC",
        onshore_bus=to_add["node_type"] == "POC",
        carrier="DC",
...
if __name__ == "__main__":
    if "snakemake" not in globals():
        ...
        snakemake = mock_snakemake("build_transmission_projects", configfiles="config/baltic/baltic_sec.yaml")
