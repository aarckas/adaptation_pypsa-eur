...
def rename_techs(label: str) -> str:
    ...
    rename = {
        ...
        "AC": "Transmission Infrastructure",
        "DC": "Transmission Infrastructure",
        "B2B": "Transmission Infrastructure",
        ...
        "import oil": "Import Oil",
        "import methanol": "Import Methanol",
        "import H2": "Import H2",
        "solid biomass for industry CC": "Carbon Capture",
        "process emissions CC": "Carbon Capture",
        "gas for industry CC": "Carbon Capture",
        "co2 sequestered": "Carbon Capture",
        "electricity distribution grid": "Electricity Distribution Grid",
        "water pits": "Hot Water Storage",
        "gas boiler": "Gas",
        "gas": "Gas",
        "Offshore Wind (AC)": "Offshore Wind (near)",
        "Offshore Wind (DC)": "Offshore Wind (far)",
